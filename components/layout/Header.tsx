    ...
    <header className="py-6 px-4 lg:py-8 lg:px-8 bg-white sticky top-0 z-50 shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          {/* TOMBOL SIGN IN - Menggantikan Ikon Search */}
          <button className="rounded-full bg-[#427693] px-6 py-2 text-sm font-semibold text-white transition-all duration-300 hover:bg-[#31576d] shadow-md hidden lg:block">
            Sign In
          </button>
